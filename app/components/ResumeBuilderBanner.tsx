        ...
        <div className="mt-[20px]">
          ...
          <div>
            <p className="text-[16px] leading-[24px] text-gray-600 max-w-[500px] mt-[30px] mb-[30px]">
              ...
              resumes that get noticed by employers. Choose from multiple
              templates and get instant feedback.
            </p>
            <div className="mb-[30px]">
              <div className="flex text-black mt-[20px]">
                <img
                  className="h-[16px] w-[16px] mr-[10px] mt-[3px]"
                  src="/assets/r1.png "
                  alt=""
                />{" "}
            ...
            <div>
              ...
              <Button text='Try Resume Builder' className="bg-gradient-to-r from-blue-300 to-blue-600"/>
            </div>
          </div>
        </div>
      </div>
